...
const JWKS_URI = "https://{YOUR-AUTH0-DOMAIN}.auth0.com/.well-known/jwks.json"
const AUTH0_API_ISSUER = "https://{YOUR-AUTH0-DOMAIN}.auth0.com/"
const AUTH0_API_AUDIENCE = "{YOUR-AUTH0-API-IDENTIFIER}"
